...
ok(adapted.includes('0.1.7-alpha.2') && adapted.includes('0.1.7-alpha.1'), 'adaptedVersions 包含 0.1.7-alpha.2 / 0.1.7-alpha.1');
...
ok(!/compat\.recommendedDsh \|\| '(?!0\.1\.7-alpha\.2)/.test(adminSrc), `recommendedDsh 兜底为 ${recommended}`);
